...
static PY_LONG_LONG __pyx_f_10fast_utils_stable_int(PyObject *, int __pyx_skip_dispatch); /*proto*/
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "fast_utils"
extern int __pyx_module_is_main_fast_utils;
...
/* #### Code section: decls ### */
static PyObject *__pyx_pf_10fast_utils_stable_int(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_text); /* proto */
...
#define __pyx_kp_u_fast_utils_pyx __pyx_string_tab[3]
...
#define __pyx_n_u_fast_utils __pyx_string_tab[7]
...
#define __pyx_n_u_stable_int __pyx_string_tab[18]
...
#define __pyx_kp_b_iso88591_1_D_q_Q_r_Rs_A_1 __pyx_string_tab[22]
...
static PyObject *__pyx_pw_10fast_utils_1stable_int(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
...
static PY_LONG_LONG __pyx_f_10fast_utils_stable_int(PyObject *__pyx_v_text, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("stable_int", 0);
...
*/
  ...
  __pyx_t_1 = PyUnicode_AsUTF8String(__pyx_v_text); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
 ...
 *     return value
*/
  __Pyx_INCREF(__pyx_v_text_bytes);
  __pyx_t_2 = __pyx_v_text_bytes;
  __pyx_t_4 = __Pyx_PyBytes_AsWritableString(__pyx_t_2); if (unlikely(__pyx_t_4 == ((char *)NULL))) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_t_5 = __Pyx_PyBytes_GET_SIZE(__pyx_t_2); if (unlikely(__pyx_t_5 == ((Py_ssize_t)-1))) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_t_6 = (__pyx_t_4 + __pyx_t_5);
  for (__pyx_t_7 = __pyx_t_4; __pyx_t_7 < __pyx_t_6; __pyx_t_7++) {
    __pyx_t_3 = __pyx_t_7;
 ...
 *     return value
*/
    __pyx_v_value = __Pyx_mod_PY_LONG_LONG(((__pyx_v_value * 0x83) + __pyx_v_c), 0x3B9ACA07, 1);
  }
...
*/
  ...
  __Pyx_AddTraceback("fast_utils.stable_int", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = -1LL;
  __pyx_L0:;
...
static PyMethodDef __pyx_mdef_10fast_utils_1stable_int = {"stable_int", (PyCFunction)(void(*)(void))(__Pyx_PyCFunction_FastCallWithKeywords)__pyx_pw_10fast_utils_1stable_int, __Pyx_METH_FASTCALL|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_10fast_utils_1stable_int(PyObject *__pyx_self, 
#if CYTHON_METH_FASTCALL
PyObject *const *__pyx_args, Py_ssize_t __pyx_nargs, PyObject *__pyx_kwds
#else
PyObject *__pyx_args, PyObject *__pyx_kwds
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("stable_int (wrapper)", 0);
  #if !CYTHON_METH_FASTCALL
  #if CYTHON_ASSUME_SAFE_SIZE
  ...
  __pyx_kwvalues = __Pyx_KwValues_FASTCALL(__pyx_args, __pyx_nargs);
  {
    ...
    if (__pyx_kwds_len > 0) {
      ...
      if (__Pyx_ParseKeywords(__pyx_kwds, __pyx_kwvalues, __pyx_pyargnames, 0, values, kwd_pos_args, __pyx_kwds_len, "stable_int", 0) < (0)) __PYX_ERR(0, 3, __pyx_L3_error)
      for (Py_ssize_t i = __pyx_nargs; i < 1; i++) {
        if (unlikely(!values[i])) { __Pyx_RaiseArgtupleInvalid("stable_int", 1, 1, 1, i); __PYX_ERR(0, 3, __pyx_L3_error) }
      }
  ...
  __Pyx_RaiseArgtupleInvalid("stable_int", 1, 1, 1, __pyx_nargs); __PYX_ERR(0, 3, __pyx_L3_error)
  __pyx_L6_skip:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_text), (&PyUnicode_Type), 1, "text", 1))) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_r = __pyx_pf_10fast_utils_stable_int(__pyx_self, __pyx_v_text);
...
static PyObject *__pyx_pf_10fast_utils_stable_int(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_text) {
  ...
  __pyx_t_1 = __pyx_f_10fast_utils_stable_int(__pyx_v_text, 1); if (unlikely(__pyx_t_1 == ((PY_LONG_LONG)-1LL) && PyErr_Occurred())) __PYX_ERR(0, 3, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyLong_From_PY_LONG_LONG(__pyx_t_1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
...
static int __pyx_pymod_exec_fast_utils(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_fast_utils},
  #if CYTHON_COMPILING_IN_CPYTHON_FREETHREADING
...
__Pyx_PyMODINIT_FUNC PyInit_fast_utils(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_fast_utils(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_fast_utils(PyObject *__pyx_pyinit_module)
#endif
{
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'fast_utils' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  #if CYTHON_USE_MODULE_STATE
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "fast_utils" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_fast_utils", 0);
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "fast_utils")) {
      if (unlikely((PyDict_SetItemString(modules, "fast_utils", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
 ...
 *     cdef bytes text_bytes = text.encode('utf-8')
*/
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_10fast_utils_1stable_int, 0, __pyx_mstate_global->__pyx_n_u_stable_int, NULL, __pyx_mstate_global->__pyx_n_u_fast_utils, __pyx_mstate_global->__pyx_d, ((PyObject *)__pyx_mstate_global->__pyx_codeobj_tab[0])); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  #if CYTHON_COMPILING_IN_CPYTHON && PY_VERSION_HEX >= 0x030E0000
  PyUnstable_Object_EnableDeferredRefcount(__pyx_t_2);
  #endif
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_stable_int, __pyx_t_2) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 8; } index[] = {{1},{179},{8},{14},{20},{18},{18},{10},{8},{13},{5},{8},{10},{8},{3},{12},{12},{10},{10},{8},{4},{6},{50}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 